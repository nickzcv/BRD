...
this["tpl"]["templates"]["edit_ad"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <!--  Add new ad form -->\r\n    <form id=\"add-ad-form\">\r\n\r\n      <div class=\"col-xs-12 col-sm-6 m-t-1 p-l-0\">\r\n        <div class=\"form-group\">\r\n          <label class=\"radio-inline\"><input type=\"radio\" name=\"type\" value=\"buy\" "
    ...
    + ((stack1 = (helpers.compare || (depth0 && depth0.compare) || alias2).call(alias1,(depth0 != null ? depth0.type : depth0),"!==","buy",{"name":"compare","hash":{},"fn":container.program(9, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "\">Куплю</div>\r\n        <div class=\"marker sell "
    + ((stack1 = (helpers.compare || (depth0 && depth0.compare) || alias2).call(alias1,(depth0 != null ? depth0.type : depth0),"!==","sell",{"name":"compare","hash":{},"fn":container.program(9, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "\">Продам</div>\r\n        <div class=\"image-error-message hidden\"></div>\r\n      </div>\r\n      <div class=\"form-group\">\r\n        <p class=\"lbl\">Раздел</p>\r\n        <select class=\"form-control\" id=\"category\" name=\"category\">\r\n          <option value=\"\">&mdash;</option>\r\n"
    ...
    + "</span>\r\n        </div>\r\n      </div>\r\n\r\n      <p class=\"lbl\">Местоположение</p>\r\n      <div class=\"country-picker\"></div>\r\n\r\n      <div class=\"form-group row\">\r\n        <div class=\"col-md-6\">\r\n          <div class=\"form-group\">\r\n            <label for=\"contacts\">Контактные данные:</label>\r\n            <input type=\"text\" class=\"form-control\" id=\"contacts\" placeholder=\"Введите название компании\" disabled=\"disabled\">\r\n            <span class=\"add-company\">Нет вашей компании? <a>Создать</a></span>\r\n          </div>\r\n          <div class=\"form-group\">\r\n            <div class=\"radio\">\r\n              <label><input type=\"radio\" id=\"profileRadio\" name=\"getContacts\" value=\"profile\" checked>Использовать контактные телефоны профиля</label>\r\n            </div>\r\n            <div class=\"radio\">\r\n              <label><input type=\"radio\" id=\"companyRadio\" name=\"getContacts\" value=\"company\">Использовать контактные телефоны компании</label>\r\n            </div>\r\n            <div class=\"radio\">\r\n              <label><input type=\"radio\" id=\"otherRadio\" name=\"getContacts\" value=\"other\" >Ввести другой контактный телефон</label>\r\n            </div>\r\n            <div class=\"form-group otherPhoneWrapper\">\r\n              <div class=\"input-group\">\r\n                <span class=\"input-group-addon\"><i class=\"ion-android-call\"></i></span>\r\n                <input type=\"text\" class=\"form-control\" id=\"otherPhone\" name=\"otherPhone\" "
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.otherPhone : depth0),{"name":"if","hash":{},"fn":container.program(14, data, 0, blockParams, depths),"inverse":container.program(16, data, 0, blockParams, depths),"data":data})) != null ? stack1 : "")
  ...
  return "            <option value=\""
    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
    + "\" "
    + ((stack1 = (helpers.compare || (depth0 && depth0.compare) || alias2).call(alias1,((stack1 = (depths[1] != null ? depths[1].category : depths[1])) != null ? stack1.id : stack1),"===",(depth0 != null ? depth0.id : depth0),{"name":"compare","hash":{},"fn":container.program(12, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + ">"
    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
    + "</option>\r\n";
},"12":function(container,depth0,helpers,partials,data) {
