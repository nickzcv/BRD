...
this["tpl"]["templates"]["left_navigation"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<ul>\r\n  <li>\r\n    <a class=\"link "
    ...
    + ((stack1 = (helpers.compare || (depth0 && depth0.compare) || alias2).call(alias1,(depth0 != null ? depth0.activePage : depth0),"===","company",{"name":"compare","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
