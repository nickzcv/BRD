...
this["tpl"]["templates"]["left_navigation"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "<ul>\r\n  <li>\r\n    <a class=\"link "
    ...
    + ((stack1 = (helpers.compare || (depth0 && depth0.compare) || alias1).call(depth0,(depth0 != null ? depth0.activePage : depth0),"===","calc",{"name":"compare","hash":{},"fn":this.program(1, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "\" href=\"#profile/calc\">\r\n      <span class=\"icon ion-ios-calculator\"></span>\r\n      <span class=\"nav-item\">Калькулятор</span>\r\n    </a>\r\n  </li>\r\n</ul>";
},"useData":true});
